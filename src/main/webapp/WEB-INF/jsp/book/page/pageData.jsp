...
<div class="row" >
    ...
    <c:forEach items="${pageBean.pageDates }" var="p">
        <div class="col-sm-6 col-md-3 fadeInLeft animated">
            <div class="thumbnail">
                <a href="${pageContext.request.contextPath}/moreBookMes?id=${p.id}">
                    <img src="${pageContext.request.contextPath}/images/${p.imgurl }" alt="通用的占位符缩略图"></a>
                <div class="caption">
                    <h3>${p.bookName }</h3>
...
<div class="container">
    <ul class="pager">
        <li><a href="javascript:findPage('${nowFrist-1 <= 1 ? 1 : nowFrist-1 }','精选图书')">&larr;上一页</a>
            <a href="javascript:findPage('${nowFrist+1 >= countFrist ? countFrist : nowFrist+1}','精选图书')">下一页
                &rarr;</a></li>
    </ul>
</div>
<!-- 分页end -->
