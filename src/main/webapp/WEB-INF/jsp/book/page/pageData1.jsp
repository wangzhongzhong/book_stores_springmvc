...
<div class="container">
    <ul class="pager">
        <li><a href="javascript:findPage('${nowFrist-1 <= 1 ? 1 : nowFrist-1 }','推荐图书')">&larr;上一页</a>
            <a href="javascript:findPage('${nowFrist+1 >= countFrist ? countFrist : nowFrist+1}','推荐图书')">下一页
                &rarr;</a></li>
    </ul>
</div>
<!-- 分页end -->
